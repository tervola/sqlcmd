...
<ul>
    <li>help:<br> Show this help
        <p>
    <li>exit:<br> Output from the program</li>
    <p>
    <li>list:<br> List of tables into the database</li>
    <p>
    <li>Select from table:<br>Select records from table, examples:</li>
    <br>SELECT * FROM name
    <br>SELECT * FROM name WHERE id > 1
    <br>SELECT id FROM name WHERE id < 1
    <p>
    <li>Insert into table, examples:
        ...
        <p>
    <li>Updating records:<br>Updating records into table, example:
        <br>UPDATE id set country_name = 'Unknown' WHERE country_name ='null'
        <p>
    <li>Deleting records, example::
